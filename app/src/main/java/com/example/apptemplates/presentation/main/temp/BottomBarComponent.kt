...
fun BottomBar(
    ...
    // Przygotowanie gradientu zdefiniowanego w theme
    ...
    NavigationBar(
        ...
        contentColor = theme.primaryText, // Domyślny kolor treści
...
private fun NavigationBarItemIcon(
    ...
    Icon(
        ...
        modifier = Modifier
            .size(24.dp)
            .scale(scale),
        tint = if (selected) theme.iconColor else theme.iconColor.copy(alpha = 0.6f)
    )
}
