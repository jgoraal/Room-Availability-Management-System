...
import com.example.apptemplates.domain.usecase.RoomFetchRepository
import com.example.apptemplates.domain.usecase.StateLoader
import com.example.apptemplates.domain.usecase.UserUseCase
...
class RoomAvailabilityViewModel(
    ...
    fun checkAvailability() {
        ...
        wrapWithLoadingState(
            ...
            block = {
                ...
                Log.e("sda", "Reservations: $reservations")
    ...
    private fun buildRoomTimeTable(
        ...
        val reservationSlots =
            reservations.map { TimeSlot(it.startTime, it.endTime, it.recurrencePattern?.endDate) }
        ...
        return reservations.mapNotNull { reservation ->
            ...
            user?.let {
                UserBookedSlot(
                    ...
                    endRecurringDate = if (reservation.isRecurring) reservation.recurrencePattern?.endDate else null
                )
            }
        }
    }
    ...
    private fun Long.convertToLocalDateTime(): LocalDateTime {
        return LocalDateTime.ofInstant(
            Instant.ofEpochMilli(this),
            ZoneOffset.UTC
        )
...
data class TimeSlot(
    val startTime: Long,
    val endTime: Long,
    val endRecurringDate: Long? = null
)
